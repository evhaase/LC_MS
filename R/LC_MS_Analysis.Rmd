...
ggplot(CalCurve1, aes(x= Conc, y= PeakArea)) + theme_bw() + geom_point() + geom_smooth(method = lm, se = FALSE) + labs(x= "Concentration of Levoglucosan (ug/mL)", y = "Peak Area", title="Calibration Curve for Levoglucosan")
